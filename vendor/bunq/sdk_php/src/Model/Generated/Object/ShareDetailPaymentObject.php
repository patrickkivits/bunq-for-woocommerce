 ...
 * @generated
 */
class ShareDetailPaymentObject extends BunqModel
{
    /**
    ...
    /**
     * @param bool $makePayments If set to true, the invited user will be able to make payments from the shared account.
     * @param bool $viewBalance If set to true, the invited user will be able to view the account balance.
     * @param bool $viewOldEvents If set to true, the invited user will be able to view events from before the share was
     * active.
     * @param bool $viewNewEvents If set to true, the invited user will be able to view events starting from the time the share
     * became active.
     * @param bool|null $makeDraftPayments If set to true, the invited user will be able to make draft payments from the shared
     * account.
     */
