 ...
 * @generated
 */
class NotificationFilterUrlObject extends BunqModel
{
    /**
    ...
    /**
     * @param string $category The notification category that will match this notification filter.
     * @param string $notificationTarget The URL to which the callback should be made.
     * @param string[]|null $allUserId The users this filter pertains to. OPTIONAL FOR BACKWARD COMPATIBILITY
     * @param string[]|null $allMonetaryAccountId The MAs this filter pertains to. OPTIONAL FOR BACKWARD COMPATIBILITY
     * @param string[]|null $allVerificationType Type of verification required for the connection.
     */
