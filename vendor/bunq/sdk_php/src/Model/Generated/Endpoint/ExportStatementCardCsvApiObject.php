 ...
 * @generated
 */
class ExportStatementCardCsvApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string $regionalFormat Required for CSV exports. The regional format of the statement, can be UK_US
...
self::FIELD_REGIONAL_FORMAT => $regionalFormat],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseExportStatementCardCsvApiObjectList
     */
    public static function listing(int $cardId, array $params = [], array $customHeaders = []): BunqResponseExportStatementCardCsvApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseExportStatementCardCsvApiObjectList::castFromBunqResponse(
