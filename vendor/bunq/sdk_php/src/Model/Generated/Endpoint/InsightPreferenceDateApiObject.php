 ...
 * @generated
 */
class InsightPreferenceDateApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
    ...
    /**
     * @param int $dayOfMonth The day of month at which budgeting/insights should start.
     */
     ...
     *
     * @return BunqResponseInsightPreferenceDateApiObjectList
     */
    public static function listing( array $params = [], array $customHeaders = []): BunqResponseInsightPreferenceDateApiObjectList
    {
        ...
        return BunqResponseInsightPreferenceDateApiObjectList::castFromBunqResponse(
