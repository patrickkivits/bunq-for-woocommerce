...
/**
 * Used to view bunq.me TabResultResponse objects belonging to a tab. A TabResultResponse is an object that holds details
 * on a tab which has been paid from the provided monetary account.
 *
 * @generated
 */
class BunqMeTabResultResponseApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
