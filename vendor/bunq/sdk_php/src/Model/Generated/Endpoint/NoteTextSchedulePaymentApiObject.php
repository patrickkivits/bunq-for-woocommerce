 ...
 * @generated
 */
class NoteTextSchedulePaymentApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextSchedulePaymentApiObjectList
     */
    public static function listing(int $schedulePaymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextSchedulePaymentApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextSchedulePaymentApiObjectList::castFromBunqResponse(
