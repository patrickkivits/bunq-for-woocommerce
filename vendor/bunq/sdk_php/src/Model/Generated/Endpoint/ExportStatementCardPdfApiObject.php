 ...
 * @generated
 */
class ExportStatementCardPdfApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_DATE_END => $dateEnd],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseExportStatementCardPdfApiObjectList
     */
    public static function listing(int $cardId, array $params = [], array $customHeaders = []): BunqResponseExportStatementCardPdfApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseExportStatementCardPdfApiObjectList::castFromBunqResponse(
