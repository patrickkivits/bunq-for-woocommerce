 ...
 * @generated
 */
class NoteTextSofortMerchantTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextSofortMerchantTransactionApiObjectList
     */
    public static function listing(int $sofortMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextSofortMerchantTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextSofortMerchantTransactionApiObjectList::castFromBunqResponse(
