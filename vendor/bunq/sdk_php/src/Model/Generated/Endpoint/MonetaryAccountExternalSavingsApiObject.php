 ...
 * @generated
 */
class MonetaryAccountExternalSavingsApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
    ...
    /**
     * The daily spending limit Amount of the MonetaryAccountExternalSavings. Defaults to 1000 EUR. Currency must match the
    ...
    /**
     * The sub-status of the MonetaryAccountExternalSavings providing extra information regarding the status. Will be NONE for
    ...
    /**
     * The status of the MonetaryAccountExternalSavings. Ignored in POST requests (always set to ACTIVE) can be CANCELLED or
     * PENDING_REOPEN in PUT requests to cancel (close) or reopen the MonetaryAccountExternalSavings. When updating the status
    ...
    /**
     * The sub-status of the MonetaryAccountExternalSavings providing extra information regarding the status. Should be ignored
     * for POST requests. In case of PUT requests with status CANCELLED it can only be REDEMPTION_VOLUNTARY, while with status
    ...
    /**
     * The reason for voluntarily cancelling (closing) the MonetaryAccountExternalSavings, can only be OTHER. Should only be
    ...
    /**
     * The optional free-form reason for voluntarily cancelling (closing) the MonetaryAccountExternalSavings. Can be any user
    ...
    /**
     * @param string $currency The currency of the MonetaryAccountExternalSavings as an ISO 4217 formatted currency code.
     * @param string $service The service the MonetaryAccountExternalSavings is connected with.
     * @param string|null $description The description of the MonetaryAccountExternalSavings. Defaults to 'bunq account'.
     * @param AmountObject|null $dailyLimit The daily spending limit Amount of the MonetaryAccountExternalSavings. Defaults to
     * 1000 EUR. Currency must match the MonetaryAccountExternalSavings's currency. Limited to 10000 EUR.
     * @param string|null $avatarUuid The UUID of the Avatar of the MonetaryAccountExternalSavings.
     * @param string|null $status The status of the MonetaryAccountExternalSavings. Ignored in POST requests (always set to
     * ACTIVE) can be CANCELLED or PENDING_REOPEN in PUT requests to cancel (close) or reopen the
     * MonetaryAccountExternalSavings. When updating the status and/or sub_status no other fields can be updated in the same
     * request (and vice versa).
     * @param string|null $subStatus The sub-status of the MonetaryAccountExternalSavings providing extra information regarding
     * the status. Should be ignored for POST requests. In case of PUT requests with status CANCELLED it can only be
     ...
     * @param string|null $reason The reason for voluntarily cancelling (closing) the MonetaryAccountExternalSavings, can only
...
self::FIELD_SAVINGS_GOAL => $savingsGoal],
     ...
     * @return BunqResponseInt
     */
    public static function update(int $monetaryAccountExternalSavingsId, string  $description = null, AmountObject  $dailyLimit = null, string  $avatarUuid = null, string  $status = null, string  $subStatus = null, string  $reason = null, string  $reasonDescription = null, string  $displayName = null, MonetaryAccountSettingObject  $setting = null, AmountObject  $savingsGoal = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
...
self::FIELD_SAVINGS_GOAL => $savingsGoal],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseMonetaryAccountExternalSavingsApiObjectList
     */
    public static function listing( array $params = [], array $customHeaders = []): BunqResponseMonetaryAccountExternalSavingsApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseMonetaryAccountExternalSavingsApiObjectList::castFromBunqResponse(
