 ...
 * @generated
 */
class WhitelistSddOneOffApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ROUTING_TYPE => $routingType],
     ...
     * @return BunqResponseInt
     */
    public static function update(int $whitelistSddOneOffId, int  $monetaryAccountPayingId = null, AmountObject  $maximumAmountPerMonth = null, AmountObject  $maximumAmountPerPayment = null, string  $routingType = null, array $customHeaders = []): BunqResponseInt
    {
        $apiClient = new ApiClient(static::getApiContext());
...
self::FIELD_ROUTING_TYPE => $routingType],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseWhitelistSddOneOffApiObjectList
     */
    public static function listing( array $params = [], array $customHeaders = []): BunqResponseWhitelistSddOneOffApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseWhitelistSddOneOffApiObjectList::castFromBunqResponse(
