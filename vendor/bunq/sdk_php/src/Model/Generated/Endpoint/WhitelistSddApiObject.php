 ...
 * @generated
 */
class WhitelistSddApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param AmountObject $maximumAmountPerMonth The maximum amount of money that is allowed to be deducted based on the
     * whitelist.
     */
    public function __construct(int  $monetaryAccountPayingId, int  $requestId, AmountObject  $maximumAmountPerMonth)
    {
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseWhitelistSddApiObjectList
     */
    public static function listing( array $params = [], array $customHeaders = []): BunqResponseWhitelistSddApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseWhitelistSddApiObjectList::castFromBunqResponse(
