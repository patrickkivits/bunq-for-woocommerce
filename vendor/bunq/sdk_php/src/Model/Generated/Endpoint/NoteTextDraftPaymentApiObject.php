 ...
 * @generated
 */
class NoteTextDraftPaymentApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextDraftPaymentApiObjectList
     */
    public static function listing(int $draftPaymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextDraftPaymentApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextDraftPaymentApiObjectList::castFromBunqResponse(
