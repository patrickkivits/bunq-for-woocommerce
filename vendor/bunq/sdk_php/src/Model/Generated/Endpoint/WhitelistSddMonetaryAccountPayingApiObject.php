 ...
 * @generated
 */
class WhitelistSddMonetaryAccountPayingApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseWhitelistSddMonetaryAccountPayingApiObjectList
     */
    public static function listing(int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseWhitelistSddMonetaryAccountPayingApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        $responseRaw = $apiClient->get(
            vsprintf(
        ...
        return BunqResponseWhitelistSddMonetaryAccountPayingApiObjectList::castFromBunqResponse(
