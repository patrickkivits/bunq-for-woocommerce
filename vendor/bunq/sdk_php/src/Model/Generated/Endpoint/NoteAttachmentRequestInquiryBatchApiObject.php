 ...
 * @generated
 */
class NoteAttachmentRequestInquiryBatchApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteAttachmentRequestInquiryBatchApiObjectList
     */
    public static function listing(int $requestInquiryBatchId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentRequestInquiryBatchApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteAttachmentRequestInquiryBatchApiObjectList::castFromBunqResponse(
