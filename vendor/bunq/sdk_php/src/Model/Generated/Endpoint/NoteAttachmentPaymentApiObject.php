 ...
 * @generated
 */
class NoteAttachmentPaymentApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteAttachmentPaymentApiObjectList
     */
    public static function listing(int $paymentId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentPaymentApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteAttachmentPaymentApiObjectList::castFromBunqResponse(
