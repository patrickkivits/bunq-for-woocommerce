 ...
 * @generated
 */
class NoteTextOpenBankingMerchantTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextOpenBankingMerchantTransactionApiObjectList
     */
    public static function listing(int $openBankingMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextOpenBankingMerchantTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextOpenBankingMerchantTransactionApiObjectList::castFromBunqResponse(
