 ...
 * @generated
 */
class NoteTextScheduleInstanceApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextScheduleInstanceApiObjectList
     */
    public static function listing(int $scheduleId, int $scheduleInstanceId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextScheduleInstanceApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextScheduleInstanceApiObjectList::castFromBunqResponse(
