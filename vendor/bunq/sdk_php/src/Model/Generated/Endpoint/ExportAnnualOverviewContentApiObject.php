...
/**
 * Fetch the raw content of an annual overview. The annual overview is always in PDF format. Doc won't display the response
 * of a request to get the content of an annual overview.
 *
 * @generated
 */
class ExportAnnualOverviewContentApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
