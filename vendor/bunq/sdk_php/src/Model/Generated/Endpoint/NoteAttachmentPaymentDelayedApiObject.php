 ...
 * @generated
 */
class NoteAttachmentPaymentDelayedApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteAttachmentPaymentDelayedApiObjectList
     */
    public static function listing(int $paymentDelayedId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentPaymentDelayedApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteAttachmentPaymentDelayedApiObjectList::castFromBunqResponse(
