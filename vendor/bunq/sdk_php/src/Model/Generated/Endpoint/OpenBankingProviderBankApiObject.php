 ...
 * @generated
 */
class OpenBankingProviderBankApiObject extends BunqModel
{
    /**
     * Field constants.
     */
    ...
    /**
     * @param string|null $accountInformationServiceStatus Whether we want to activate the account information service for the
     * bank provider.
     * @param string|null $paymentInformationServiceStatus Whether we want to activate the payment information service for the
     * bank provider.
     */
