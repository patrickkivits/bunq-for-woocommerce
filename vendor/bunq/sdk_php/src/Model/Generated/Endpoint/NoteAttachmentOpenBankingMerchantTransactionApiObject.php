 ...
 * @generated
 */
class NoteAttachmentOpenBankingMerchantTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteAttachmentOpenBankingMerchantTransactionApiObjectList
     */
    public static function listing(int $openBankingMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentOpenBankingMerchantTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteAttachmentOpenBankingMerchantTransactionApiObjectList::castFromBunqResponse(
