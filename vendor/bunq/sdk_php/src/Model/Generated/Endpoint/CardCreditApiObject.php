...
/**
 * With bunq it is possible to order credit cards that can then be connected with each one of the monetary accounts the
 * user has access to (including connected accounts).
 *
 * @generated
 */
class CardCreditApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
    ...
    /**
     * The first line of text on the card, used as name/description for it. It can contain at most 17 characters and it can be
     * empty.
     *
     * @var string|null
     */
     ...
     * @param string|null $firstLine The first line of text on the card, used as name/description for it. It can contain at
     * most 17 characters and it can be empty.
     ...
     */
    public function __construct(string  $secondLine, string  $nameOnCard, string  $type, string  $productType, string  $firstLine = null, string  $preferredNameOnCard = null, PointerObject  $alias = null, array  $pinCodeAssignment = null, int  $monetaryAccountIdFallback = null, string  $orderStatus = null)
    {
     ...
     */
    public static function create(string  $secondLine, string  $nameOnCard, string  $type, string  $productType, string  $firstLine = null, string  $preferredNameOnCard = null, PointerObject  $alias = null, array  $pinCodeAssignment = null, int  $monetaryAccountIdFallback = null, string  $orderStatus = null, array $customHeaders = []): BunqResponseCardCredit
    {
