 ...
 * @generated
 */
class NoteAttachmentIdealMerchantTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
...
self::FIELD_ATTACHMENT_ID => $attachmentId],
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteAttachmentIdealMerchantTransactionApiObjectList
     */
    public static function listing(int $idealMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteAttachmentIdealMerchantTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteAttachmentIdealMerchantTransactionApiObjectList::castFromBunqResponse(
