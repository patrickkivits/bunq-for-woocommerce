 ...
 * @generated
 */
class NoteTextWhitelistResultApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextWhitelistResultApiObjectList
     */
    public static function listing(int $whitelistId, int $whitelistResultId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextWhitelistResultApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextWhitelistResultApiObjectList::castFromBunqResponse(
