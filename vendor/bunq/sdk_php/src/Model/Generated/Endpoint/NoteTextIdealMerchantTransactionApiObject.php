 ...
 * @generated
 */
class NoteTextIdealMerchantTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextIdealMerchantTransactionApiObjectList
     */
    public static function listing(int $idealMerchantTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextIdealMerchantTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextIdealMerchantTransactionApiObjectList::castFromBunqResponse(
