 ...
 * @generated
 */
class NoteTextAdyenCardTransactionApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
     ...
     * @param string[] $customHeaders
     *
     * @return BunqResponseNoteTextAdyenCardTransactionApiObjectList
     */
    public static function listing(int $adyenCardTransactionId, int $monetaryAccountId = null, array $params = [], array $customHeaders = []): BunqResponseNoteTextAdyenCardTransactionApiObjectList
    {
        $apiClient = new ApiClient(static::getApiContext());
        ...
        return BunqResponseNoteTextAdyenCardTransactionApiObjectList::castFromBunqResponse(
