...
/**
 * Fetch the raw content of a statement export. The returned file format could be MT940, CSV or PDF depending on the
 * statement format specified during the statement creation. The doc won't display the response of a request to get the
 * content of a statement export.
 *
 * @generated
 */
class ExportStatementContentApiObject extends BunqModel
{
    /**
     * Endpoint constants.
     */
