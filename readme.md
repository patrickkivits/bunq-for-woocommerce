...
3. Enter **Client ID** and **Client Secret** in the plugin settings and **Save changes**.
4. Click **OAuth Authorization Request** to authorize the plugin in the bunq app.
...
6. Scan this QR code with the bunq app to select the bank accounts to want to access.
